...
type ReplaceAll<S extends string, From extends string, To extends string> =
  From extends '' ? S :
    S extends `${infer RS}${From}` ? `${ReplaceAll<RS, From, To>}${To}` :
      S extends `${infer RS}${From}${infer RE}` ? `${ReplaceAll<RS, From, To>}${To}${ReplaceAll<RE, From, To>}` :
        S extends `${From}${infer RE}` ? `${To}${ReplaceAll<RE, From, To>}` : S
