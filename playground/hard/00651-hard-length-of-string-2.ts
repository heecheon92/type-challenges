/*
  ...
  -------
  by null (@uid11) #어려움 #template-literal
  ...
  > GitHub에서 보기: https://tsch.js.org/651/ko
*/

/* _____________ 여기에 코드 입력 _____________ */

type LengthOfString<S extends string, H extends unknown[] = []> =
  S extends `${infer F}${infer R}` ? LengthOfString<R, [F, ...H]> : H['length']
...
/*
  > 정답 공유하기: https://tsch.js.org/651/answer/ko
  > 정답 보기: https://tsch.js.org/651/solutions
